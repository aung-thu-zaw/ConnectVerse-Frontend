...
const SenderFileAttachmentBubble: React.FC = () => {
  return (
    <>
      <div className="w-full flex items-center justify-end">
        <div className="flex items-start gap-2.5">
          ...
          <div className="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-light-accent rounded-ee-xl rounded-s-xl dark:bg-dark-accent">
            ...
            <div className="flex items-start my-2.5 bg-gray-100 dark:bg-green-700 rounded-md p-2">
              <div className="me-2">
                ...
                <span className="flex text-xs items-center justify-center font-normal text-gray-500 dark:text-gray-200 gap-2">
                  12 Pages
                  <svg
              ...
              <div className="inline-flex self-center items-center">
                <button
                  className="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 focus:ring-0 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-300 dark:hover:bg-gray-200 "
                  type="button"
                >
                  <svg
                    className="w-4 h-4 text-gray-900 dark:text-gray-800"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 20 20"
...
export default SenderFileAttachmentBubble;
